package net.unadeca.ana.galeriajose.util;
...
import net.unadeca.ana.galeriajose.activities.ImagenGrande;
...
public class ImageAdapter extends RecyclerView.Adapter<ImageViewHolder> {
    ...
    public ImageAdapter(List<RunImage> listRunImages, Context context) {
